<!-- This sets the $author_info variable -->
<?php
/**
 * Author object
 * @var object
 */
$author_info = ( isset( $_GET['author_name'] ) ) ? get_user_by('slug', $author_name) : get_userdata( intval( get_the_author_ID() ) );
?>
	...
	<div class="row">
		...
		<div class="col-sm-10">
			...
			<?php if( $author_info->user_url ) { ?>
				<p itemprop="url"><strong><?php _e('Web site:', 'ItalyStrap'); ?></strong> <a href="<?php echo esc_html( $author_info->user_url ); ?>"><?php echo esc_html( $author_info->user_url ); ?></a></p>
			<?php } ?>
