!function(o) {
    ...
    function a(n) {
        return this.each(function() {
            var t = c(this), e = t.data("bs.carousel"), i = c.extend({}, p.DEFAULTS, t.data(), "object" == typeof n && n), o = "string" == typeof n ? n : i.slide;
            e || t.data("bs.carousel", e = new p(this, i)), "number" == typeof n ? e.to(n) : o ? e[o]() : i.interval && e.pause().cycle();
        });
    }
    p.VERSION = "3.3.7", p.TRANSITION_DURATION = 600, p.DEFAULTS = {
        ...
        var r = o[0], l = c.Event("slide.bs.carousel", {
            relatedTarget: r,
            direction: s
        });
        if (this.$element.trigger(l), !l.isDefaultPrevented()) {
            if (this.sliding = !0, n && this.pause(), this.$indicators.length) {
                ...
                var h = c(this.$indicators.children()[this.getItemIndex(o)]);
                h && h.addClass("active");
            }
            ...
            return c.support.transition && this.$element.hasClass("slide") ? (o.addClass(t), 
            ...
            }).emulateTransitionEnd(p.TRANSITION_DURATION)) : (i.removeClass("active"), o.addClass("active"), 
            this.sliding = !1, this.$element.trigger(d)), n && this.cycle(), this;
        }
    };
    var t = c.fn.carousel;
    c.fn.carousel = a, c.fn.carousel.Constructor = p, c.fn.carousel.noConflict = function() {
        return c.fn.carousel = t, this;
    };
    var e = function(t) {
        var e, i = c(this), o = c(i.attr("data-target") || (e = i.attr("href")) && e.replace(/.*(?=#[^\s]+$)/, ""));
        if (o.hasClass("carousel")) {
            var n = c.extend({}, o.data(), i.data()), s = i.attr("data-slide-to");
    ...
    s.fn.modal = r, s.fn.modal.Constructor = a, s.fn.modal.noConflict = function() {
        ...
        var e = s(this), i = e.attr("href"), o = s(e.attr("data-target") || i && i.replace(/.*(?=#[^\s]+$)/, "")), n = o.data("bs.modal") ? "toggle" : s.extend({
            remote: !/#/.test(i) && i
        }, o.data(), e.data());
    ...
    m.VERSION = "3.3.7", m.TRANSITION_DURATION = 150, m.DEFAULTS = {
        ...
        if (this.hasContent() && this.enabled) {
            ...
            if (r) {
                var c = s, p = this.getPosition(this.$viewport);
                s = "bottom" == s && l.bottom + d > p.bottom ? "top" : "top" == s && l.top - d < p.top ? "bottom" : "right" == s && l.right + h > p.width ? "left" : "left" == s && l.left - h < p.left ? "right" : s, 
        ...
        var d = /top|bottom/.test(e), c = d ? 2 * h.left - o + r : 2 * h.top - n + l, p = d ? "offsetWidth" : "offsetHeight";
...
}(jQuery), jQuery.noConflict()(function(t) {
    "use strict";
    t(document).ready(function() {
        t("#cat").addClass("form-control"), t("select").addClass("form-control"), t("#wp-calendar").addClass("table table-hover"), 
        t("td a").addClass("badge").css("margin-right", "-10px");
    });
});
