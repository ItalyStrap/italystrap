...
class CommentHelperSubscriber implements SubscriberInterface
{
	 ...
	 * @return string
	 */
	public function add_class_button_to_cancel_reply( $formatted_link ) {
	 ...
	 *
	 */
	function display_message_if_comments_are_closed(): void {
	 ...
	 */
	function comment_form_args( $comment_author, $user_identity ): array {
