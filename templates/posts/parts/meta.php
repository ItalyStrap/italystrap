...
?><footer class="entry-footer">
	<ul class="entry-meta list-inline small">
		<li class="list-inline-item datePublished">
			<span class="glyphicon glyphicon-calendar"></span>
			<a href="<?php \the_permalink(); ?>" title="<?php \the_title(); ?>">
				<time datetime="<?php \the_time( 'Y-m-d' ) ?>" itemprop="datePublished">
					<?php \the_time( \get_option( 'date_format' ) ); ?>
				</time>
			</a>
		</li>
		...
		<?php if ( \comments_open() ) : ?>
			<li class="list-inline-item responses">
		...
		if ( $category ) : ?>
			<li class="list-inline-item category">
				<span class="glyphicon glyphicon-folder-open"></span> <?php \the_category( ' & ' );?>
			</li>
		<?php endif; ?>

		<?php \the_tags(
			'<li class="list-inline-item tags" itemprop="keywords"><span class="glyphicon glyphicon-tags"></span> ',
			' - ',
			'</li>'
		); ?>
	</ul>
