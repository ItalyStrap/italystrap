...
namespace ItalyStrap\Navigation\Infrastructure;
...
class BootstrapNavMenu extends Walker_Nav_Menu {
	...
	public function start_lvl( &$output, $depth = 0, $args = [] ) {
		...
		$this->listenerRegister->addListener( 'nav_menu_submenu_css_class', $listener, 10, 3 );
		parent::start_lvl( $output, $depth, $args );
		$this->listenerRegister->removeListener( 'nav_menu_submenu_css_class', $listener );
