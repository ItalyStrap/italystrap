		...
		<li id="menu-item-<?php echo $item_id; ?>" class="<?php echo implode(' ', $classes ); ?>">
				...
				<dt class="menu-item-handle">
					...
					<span class="item-controls">
						...
						<span class="item-order hide-if-js">
	                        ...
	                        ?>" class="item-move-up">
								<abbr title="<?php esc_attr_e('Move up'); ?>">&#8593;</abbr>
							</a>
							|
							<a href="<?php
								echo wp_nonce_url(
							...
							?>" class="item-move-down">
								<abbr title="<?php esc_attr_e('Move down'); ?>">&#8595;</abbr>
							</a>
						</span>
	                    <a class="item-edit" id="edit-<?php echo $item_id; ?>" title="<?php esc_attr_e('Edit Menu Item'); ?>" href="<?php
								echo ( isset( $_GET['edit-menu-item'] ) && $item_id === $_GET['edit-menu-item'] ) ? admin_url( 'nav-menus.php' ) : esc_url(
										add_query_arg(
											'edit-menu-item',
											$item_id,
											remove_query_arg(
												$removed_args,
												admin_url(
													'nav-menus.php#menu-item-settings-' . $item_id
												)
											)
										)
									);
			...
			<div class="menu-item-settings" id="menu-item-settings-<?php echo $item_id; ?>">
				...
				<p class="field-custom description description-wide">
					<label for="edit-menu-item-glyphicon-<?php echo $item_id; ?>">
						<?php _e( 'Glyphicon or your icon class', 'ItalyStrap' ); ?><br />
						<input type="text" id="edit-menu-item-glyphicon-<?php echo $item_id; ?>" class="widefat code edit-menu-item-custom" name="menu-item-glyphicon[<?php echo $item_id; ?>]" value="<?php echo esc_attr( $item->glyphicon ); ?>" />
					</label>
				</p>
				<?php
				...
				<div class="menu-item-actions description-wide submitbox">
					...
					<a class="item-delete submitdelete deletion" id="delete-<?php echo $item_id; ?>" href="<?php
						...
						?>">
						<?php _e('Remove'); ?>
					</a> <span class="meta-sep"> | </span> <a class="item-cancel submitcancel" id="cancel-<?php echo $item_id; ?>" href="<?php
					echo esc_url(
							add_query_arg(
								array(
